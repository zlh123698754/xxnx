...
public class zhouyuebaoJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        for (user stu:user1) {
            try {
                 ...
                 okhttp.bao(okhttp.getToken( okhttp.run(stu.getSchool_id(),stu.getM_data(),stu.getZhanghao())),"week",huodecontent(stu.getUser_id()));
